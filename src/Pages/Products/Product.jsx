    ...
    return (
        <div className="w-full max-w-[340px] space-y-3 rounded-xl bg-white p-4 shadow-lg dark:bg-[#18181B]">
            ...
            <div className="space-y-2 font-semibold">
                ...
                <p className="text-xs font-semibold text-gray-400 md:text-sm">Brand: {item.brand}</p>
                <p className="text-xs font-semibold text-gray-400 md:text-sm">Brand: {item.category}</p>
                <p>${item.price}</p>
            </div>
