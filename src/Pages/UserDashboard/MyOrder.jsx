    ...
    return (
        <div className="p-4">
            ...
            <div className="max-w-screen-xl mx-auto">
                ...
                {
                    orderData.map((order, idx) => <div key={idx} className="border-b border-gray-300 mt-4">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 items-center justify-between gap-x-7 gap-y-6 py-4">
                            ...
                            <div className="flex gap-4 justify-around h-full">
                                ...
                                <div>
                                    <button onClick={() => {document.getElementById('my_modal_3').showModal(); handleOrderSummary(order)}} type="button" className="flex items-center justify-center font-medium tracking-wide bg-slate-900 px-4 py-2.5 rounded-md text-sm text-white cursor-pointer">View</button>
                                </div>
                            </div>
                        </div>
                    </div>)
                ...
                <dialog id="my_modal_3" className="modal">
                    <div className="modal-box max-w-[70%]">
                        <form method="dialog">
                            <button className="btn btn-sm btn-circle btn-ghost right-2 top-2 bg-black text-white font-semibold absolute">✕</button>
                        </form>
                        <OrderSummaryModal order={order}/>
                    </div>
                </dialog>
            </div>
        </div>
